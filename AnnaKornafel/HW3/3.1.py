...
# print("In Zen of Python the word \"better\" is repeated", zen_of_Python.count("better"), "times")
# print("In Zen of Python the word \"never\" is repeated", zen_of_Python.count("never"), "times")
# print("In Zen of Python the word \"is\" is repeated", zen_of_Python.count("is"), "times")
