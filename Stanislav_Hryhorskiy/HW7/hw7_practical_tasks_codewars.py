...
# "Wow this is really amazing". String should be capitalized
# and properly spaced. Using re and string is not allowed.

def filter_words(st):
    result = " ".join(st.split()).capitalize()
    return result
...
# What ways of achieving this does you know?

def number_to_string(num):
    return str(num)
    # return f"{num}"
    # return "%s" % num
    # return "{res}".format(res=num)
